  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" title class="c-999 fsize14">{{course.subjectOneTitle}}</a>
        \
        <span class="c-333 fsize14">{{course.subjectTwoTitle}}</span>
      </section>
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="course.cover" :alt="course.subjectTwoTitle" class="dis c-v-pic" height="357px">
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            <h2 class="hLh30 txtOf mt15">
              <span class="c-fff fsize24">{{course.subjectTwoTitle}}</span>
            </h2>
                        ...
                        <ul>
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="lesson in chapter.children" :key="lesson.id">
                                <a :href="'/player/' + lesson.videoSourceId" :title="lesson.title" target="_blank">
                                  <span class="fr">
                                    <i class="free-icon vam mr10">免费试听</i>
                                  </span>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>{{lesson.title}}
                                </a>
                              </li>                         
                            </ol>
                          </li>
  ...
  methods:{
    initCourse(){
      courseApi.getCourseDetail(this.courseId).then(response => {
        this.course = response.data.data.courseDetailVo
